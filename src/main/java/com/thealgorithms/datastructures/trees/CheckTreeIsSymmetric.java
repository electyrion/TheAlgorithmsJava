...
public final class CheckTreeIsSymmetric {
    ...
    protected static boolean isSymmetric(Node root) {
        if (root == null) {
            return true;
        }
...
//         if (leftSubtreeRoot == null || rightSubtreeRoot == null || leftSubtreeRoot.right == null || rightSubtreeRoot.left == null || leftSubtreeRoot.left == null || rightSubtreeRoot.right == null) {
//             return false;
//         }
